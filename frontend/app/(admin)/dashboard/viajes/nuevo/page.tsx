  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6 animate-in fade-in duration-700 pb-20">
      ...
      <div className="flex items-center justify-between px-2">
        ...
        <h1 className="text-2xl font-black text-secundario uppercase tracking-tighter">Nuevo Vuelo</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="lg:col-span-5 p-10 space-y-6 bg-gray-50/30">
              <div className="space-y-4">
                <div className="space-y-1">
                  ...
                  <input 
                    type="text" placeholder="Ej: España" 
                ...
                <div className="space-y-1">
                  ...
                  <input 
                    type="text" placeholder="VALENCIA" 
            ...
            <div className="lg:col-span-5 p-10 space-y-6 bg-white">
              <div className="space-y-4">
                <div className="space-y-1">
                  ...
                  <input 
                    type="text" placeholder="Ej: Irlanda" 
                    className="w-full bg-transparent text-base font-bold text-secundario outline-none border-b border-gray-200 focus:border-primario py-1 transition-all"
        ...
        {/* Resto del formulario (Descripción, Precio, Imagen, Botón) */}
        <div className="bg-white p-8 rounded-[2rem] border border-gray-100 space-y-3 shadow-sm group hover:border-primario transition-all duration-300">
          ...
          <textarea 
            ...
            rows={4}
            className="w-full text-sm font-medium text-secundario outline-none p-0 focus:ring-0 placeholder:text-gray-200 bg-transparent resize-none"
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-white p-6 rounded-[2rem] border border-gray-100 flex items-center gap-5 group hover:border-green-500 transition-all duration-300">
            ...
            <div className="flex-1">
              ...
              <input type="number" step="0.01" placeholder="0.00" className="w-full text-xl font-black text-secundario outline-none focus:ring-0 placeholder:text-gray-100" onChange={e => setForm({...form, precio: e.target.value})} />
            </div>
          </div>
          ...
          <div className="bg-white p-6 rounded-[2rem] border border-gray-100 flex items-center gap-5 group hover:border-primario transition-all duration-300">
            ...
            <div className="flex-1">
              ...
              <input type="text" placeholder="https://..." className="w-full text-xs font-bold text-secundario outline-none focus:ring-0 placeholder:text-gray-200" onChange={e => setForm({...form, img: e.target.value})} />
            </div>
          </div>
        </div>
