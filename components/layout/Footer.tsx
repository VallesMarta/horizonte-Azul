...
export default function Footer() {
  ...
  return (
    <footer className="bg-secundario text-blanco-fijo w-full relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 text-center lg:text-left">
          ...
          <div className="lg:col-span-2 flex flex-col items-center lg:items-start space-y-4">
            ...
            <p className="text-sm leading-relaxed opacity-80 max-w-sm">
              ...
              confianza de
              <strong className="text-blanco-fijo"> Horizonte Azul</strong>.
              Seguridad, rapidez y eficiencia en cada reserva.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center lg:items-start space-y-4">
            ...
            <ul className="flex flex-col gap-2 text-sm">
              <li>
                <Link
                  href="/reserva-vuelos"
                  className="hover:text-iconos transition-all inline-block"
                >
                  Reservas de vuelos
                </Link>
              </li>
          ...
          <div className="flex flex-col items-center lg:items-start space-y-4">
            ...
            <ul className="flex flex-col gap-2 text-sm">
              <li>
                <Link
                  href="/media/multimedia/legal/avisoLegal.pdf"
                  className="hover:text-iconos transition-all inline-block"
                >
                  Aviso Legal
                </Link>
              ...
              <li>
                <Link
                  href="/media/multimedia/legal/politicaPrivacidadDatos.pdf"
                  className="hover:text-iconos transition-all inline-block"
                >
              ...
              <li>
                <Link
                  href="/media/multimedia/legal/politicaCookies.pdf"
                  className="hover:text-iconos transition-all inline-block"
                >
                  Política de Cookies
                </Link>
              ...
              <li>
                <Link
                  href="/media/multimedia/legal/condicionesGeneralesVenta.pdf"
                  className="hover:text-iconos transition-all inline-block"
                >
          ...
          <div className="flex flex-col items-center lg:items-start space-y-4">
            ...
            <div className="flex gap-4">
              <a
                href="#"
                className="bg-blanco-fijo/10 p-2 rounded-full hover:bg-iconos hover:text-secundario transition-all"
              >
                <FaInstagram size={20} />
              </a>
              <a
